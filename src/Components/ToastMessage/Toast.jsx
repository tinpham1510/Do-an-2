...
const ToastJS = ({showToast, setToast}) => {
    return (
        <>
        <div>
       <Row>
      <Col xs={6}>
          <ToastContainer position='top-end' style={{transform: 'translate(calc(35% + 32px), -110%)'}}>
          ...
          <Toast.Body style={{color:"white"}}>Đã thêm vào danh sách thành công</Toast.Body>
        </Toast>
          </ToastContainer>
      </Col>
    </Row>
